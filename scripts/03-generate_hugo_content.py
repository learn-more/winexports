...
Usage:
    uv run scripts/03-generate_hugo_content.py           # clean then generate
    uv run scripts/03-generate_hugo_content.py --clean   # clean only
...
---
# This file is auto-generated by scripts/03-generate_hugo_content.py
title: "{dll_name}"
datakey: "{safe_name}"
weight: {weight}
---
